---
name: bloatware-log
description: View, search, and summarise the bloatware operations log at <workspace>/bloatware-log.jsonl. Use when the user asks "what bloatware did I remove", "show my debloat history", "what did I disable on this phone", or wants to audit past package operations before restoring something.
---
...
1. Read `<workspace>/bloatware-log.jsonl` line-by-line. If missing, tell the user no operations have been logged yet.
